...
class ExcelDataValidator:
    ...
    def update_date_labels(self, file, start_date_var, end_date_var):
        ...
        if file:
            ...
            if 'Submitted On' in df.columns:
                ...
                # Update the UI labels for the respective file
                start_date_var.set(f"{file_name}\nEarliest date: {min_date.strftime('%d-%m-%Y')}")
                end_date_var.set(f"{file_name}\nLatest date: {max_date.strftime('%d-%m-%Y')}\n")
            else:
    ...
    def validate_data(self):
        ...
        columns_to_check = ['Submitted On', 'Task ID', 'Route/Portacabin ID', 'Site Address', 'Site Code', 'Postal Code', 'Status']
